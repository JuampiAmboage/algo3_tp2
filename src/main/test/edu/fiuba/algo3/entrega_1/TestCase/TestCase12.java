...
public class TestCase12 {
    ...
    @Test void alSacarleTodoElEscudoAUnAsimiladorYSeguirDaniandoloPierdeVida(){
        Asimilador asimilador = new Asimilador(new Volcan()); //empieza con 450 de vida y 450 de escudo

        asimilador.daniar(450); //aca pierde _todo el escudo
    ...
    public void alSacarleTodoElEscudoYParteDeLaVidaAUnAsimiladorSoloRecuperaEscudo(){
        ...
        for(int i=0;i<10;i++)
            asimilador.realizarAccionesTurno(); //pasan unos cuantos turnos
